...
console.log('Building Record Chief (no-compile mode)...');
...
// Copy app.jsx as-is (will be compiled by Babel standalone in browser)
fs.copyFileSync('app.jsx', path.join(out, 'app.jsx'));
...
<body>
  ...
  <script>
    ...
    if(s){s.classList.add('done');setTimeout(function(){s&&s.parentNode&&s.parentNode.removeChild(s);},700);}
    if(navigator.onLine){fetch('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Space+Mono:wght@400;700&display=swap').catch(function(){});}
